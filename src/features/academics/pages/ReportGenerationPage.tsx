                ...
                filteredStudents.map(student => (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className={`text-sm font-medium ${
                                    selectedStudentId === student.studentID ? 'text-blue-700 dark:text-blue-300' : 'text-gray-900 dark:text-gray-200'
                                }`}>
                                    {student.name}
                                </p>
                        ...
                        <ChevronRight className={`w-4 h-4 ${
                             selectedStudentId === student.studentID ? 'text-blue-500' : 'text-gray-300'
                        }`} />
                    </button>
                ))
            )}
